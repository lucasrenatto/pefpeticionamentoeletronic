...
<body>
    ...
    <div style="margin-top: 85px;">
        <h4 class="custom-form-title">LISTA DE DOCUMENTO único <span><a class='btn btn-success ml-3' href="insert.php"> Adicionar</a></span></h4>
        <hr>
        <table class="table table-stripped">
            ...
            <tbody>
                <?php
                    $sql = "SELECT d.*, t.Nome as tNome FROM DOCUMENTO d
                    INNER JOIN TIPO t ON d.TIPO_Codigo = t.Codigo";
