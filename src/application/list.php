...
<body>
    ...
    <div style="margin-top: 85px;">
        <h4 class="custom-form-title">LISTA DE PETIÇão de 1º grau <span><a class='btn btn-success ml-3' href="insert.php"> Adicionar</a></span></h4>
        <hr>
        <table class="table table-stripped">
            <thead>
                ...
                <th scope="col">Assunto Principal</th>
            ...
            <tbody>
                <?php
                   ...
                   p.*, 
                   a.Nome as ASSUNTO
               FROM PETICAO_INICIAL_PRIMEIRO_GRAU p
               INNER JOIN ASSUNTO_PRINCIPAL a ON a.Codigo = p.ASSUNTO_PRINCIPAL_Codigo";
                    ...
                    if($response){
                        ...
                        if($numRows > 0)
                        {
                            ...
                            echo "<tr>
                            <td colspan='3'> Nenhuma petição encontrada.</th>
                                </tr>";
                        }   
                    } else {
                        echo "<tr>
