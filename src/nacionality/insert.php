<?php 
    ...
    if(!empty($_POST['Nome'])){
        ...
        if($numRowsSelect> 0)
        {
            ...
            $sqlInsert = "INSERT INTO NACIONALIDADE (Nome) VALUES (?)";
...
<body>
    ...
    <div style="margin-top: 85px;">
        <h4 class="custom-form-title">CADASTRO DE Nacionalidade</h4>
        <hr>
        <form method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
            <div class="form-group label-floating">
                <label  class="control-label" for="Nome">Nacionalidade:</label>
                <input type="text" name='Nome' class="form-control" id="Nome" title="Digite a Nacionalidade">
            </div>
