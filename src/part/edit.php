<?php 
    ...
    if(!empty($_GET['Codigo'])){
        ...
        $sqlUpdate = "UPDATE PARTE SET Pessoa = ?, CPF = ?, RG = ?, Orgao_Emissor = ?, Nome = ?, Genero = ?, CEP = ?, Numero = ?, Complemento = ?, PARTICIPACAO_Codigo = ?, ESTADO_CIVIL_Codigo = ?, NACIONALIDADE_Codigo = ?, PROFISSAO_Codigo = ? WHERE Codigo = ?";
        $cmd = mysqli_prepare($connection, $sqlUpdate);
        mysqli_stmt_bind_param($cmd,'sssssssssssssi',$pessoa,$cpf,$rg,$orgao_emissor,$nome,$genero,$cep,$numero,$complemento,$participacao,$estado_civil,$nacionalidade,$profissao, $codigo);
        mysqli_stmt_execute($cmd);
    ...
    <div style="margin-top: 85px;">
        ...
        <form method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
            ...
            <div class="form-group label-floating">
                ...
                <input type="text" name='nome' class="form-control" id="nome" title="Digite o Nome" value='<?php echo $data['Nome'] ?>'>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" name='cpf' class="form-control" id="cpf" title="Digite o CPF" value='<?php echo $data['CPF'] ?>'>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group label-floating">
                        <label  class="control-label" for="rg">RG:</label>
                        <input type="text" name='rg' class="form-control" id="rg" title="Digite o RG" value='<?php echo $data['RG'] ?>'>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group label-floating">
                        <label  class="control-label" for="orgao_emissor">Órgão emissor:</label>
                        <input type="text" name='orgao_emissor' class="form-control" id="orgao_emissor" title="Digite o órgão emissor" value='<?php echo $data['Orgao_Emissor'] ?>'>
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" name='cep' class="form-control" id="cep" title="Digite o CEP" value='<?php echo $data['CEP'] ?>'>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group label-floating">
                        <label  class="control-label" for="numero">Número:</label>
                        <input type="text" name='numero' class="form-control" id="numero" title="Digite o Número" value='<?php echo $data['Numero'] ?>'>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group label-floating">
                        <label  class="control-label" for="complemento">Complemento:</label>
                        <input type="text" name='complemento' class="form-control" id="complemento" title="Digite o Complemento" value='<?php echo $data['Complemento'] ?>'>
                    </div>
                </div>
            </div>
            <div class="form-row">
